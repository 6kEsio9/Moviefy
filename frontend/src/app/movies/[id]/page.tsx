...
import ReviewList from "@/app/components/MovieID/ReviewList";

export default function MovieDetails() {
  const movie = getMovie(getMovieId())!

  return(
    <Grid container direction={"column"} sx={{marginTop: "40px", marginBottom: "15px", marginRight: "5%", marginLeft: "10%"}}>
